 ...
 * 
 */
!function(e,o,t){"use strict";e.fn.scrollUp=function(o){e.data(t.body,"scrollUp")||(e.data(t.body,"scrollUp",!0),e.fn.scrollUp.init(o))},e.fn.scrollUp.init=function(n){var l,s,i,c,a,r,d=e.fn.scrollUp.Settings=e.extend({},e.fn.scrollUp.defaults,n),u=!1;switch(r=d.scrollTrigger?e(d.scrollTrigger):e("<a/>",{id:d.scrollName,href:"#top"}),d.scrollTitle&&r.attr("title",d.scrollTitle),r.appendTo("body"),d.scrollImg||d.scrollTrigger||r.html(d.scrollText),r.css({display:"none",position:"fixed",zIndex:d.zIndex}),d.activeOverlay&&e("<div/>",{id:d.scrollName+"-active"}).css({position:"absolute",top:d.scrollDistance+"px",width:"100%",borderTop:"1px dotted"+d.activeOverlay,zIndex:d.zIndex}).appendTo("body"),d.animation){case"fade":l="fadeIn",s="fadeOut",i=d.animationSpeed;break;case"slide":l="slideDown",s="slideUp",i=d.animationSpeed;break;default:l="show",s="hide",i=0}c="top"===d.scrollFrom?d.scrollDistance:e(t).height()-e(o).height()-d.scrollDistance,e(o).scroll(function(){e(o).scrollTop()>c?u||(r[l](i),u=!0):u&&(r[s](i),u=!1)}),d.scrollTarget?"number"==typeof d.scrollTarget?a=d.scrollTarget:"string"==typeof d.scrollTarget&&(a=Math.floor(e(d.scrollTarget).offset().top)):a=0,r.click(function(o){o.preventDefault(),e("html, body").animate({scrollTop:a},d.scrollSpeed,d.easingType)})},e.fn.scrollUp.defaults={scrollName:"scrollUp",scrollDistance:300,scrollFrom:"top",scrollSpeed:300,easingType:"linear",animation:"fade",animationSpeed:200,scrollTrigger:!1,scrollTarget:!1,scrollText:"Scroll to top",scrollTitle:!1,scrollImg:!1,activeOverlay:!1,zIndex:2147483647},e.fn.scrollUp.destroy=function(n){e.removeData(t.body,"scrollUp"),e("#"+e.fn.scrollUp.Settings.scrollName).remove(),e("#"+e.fn.scrollUp.Settings.scrollName+"-active").remove(),e.fn.jquery.split(".")[1]>=7?e(o).off("scroll",n):e(o).unbind("scroll",n)},e.scrollUp=e.fn.scrollUp}(jQuery,window,document),function(e){var o={url:!1,callback:!1,target:!1,duration:120,on:"mouseover",touch:!0,onZoomIn:!1,onZoomOut:!1,magnify:1};e.zoom=function(o,t,n,l){var s,i,c,a,r,d,u,f=e(o),p=f.css("position"),m=e(t);return o.style.position=/(absolute|fixed)/.test(p)?p:"relative",o.style.overflow="hidden",n.style.width=n.style.height="",e(n).addClass("zoomImg").css({position:"absolute",top:0,left:0,opacity:0,width:n.width*l,height:n.height*l,border:"none",maxWidth:"none",maxHeight:"none"}).appendTo(o),{init:function(){i=f.outerWidth(),s=f.outerHeight(),t===o?(a=i,c=s):(a=m.outerWidth(),c=m.outerHeight()),r=(n.width-i)/a,d=(n.height-s)/c,u=m.offset()},move:function(e){var o=e.pageX-u.left,t=e.pageY-u.top;t=Math.max(Math.min(t,c),0),o=Math.max(Math.min(o,a),0),n.style.left=o*-r+"px",n.style.top=t*-d+"px"}}},e.fn.zoom=function(t){return this.each(function(){var n=e.extend({},o,t||{}),l=n.target&&e(n.target)[0]||this,s=this,i=e(s),c=document.createElement("img"),a=e(c),r="mousemove.zoom",d=!1,u=!1;if(!n.url){var f=s.querySelector("img");if(f&&(n.url=f.getAttribute("data-src")||f.currentSrc||f.src),!n.url)return}i.one("zoom.destroy",function(e,o){i.off(".zoom"),l.style.position=e,l.style.overflow=o,c.onload=null,a.remove()}.bind(this,l.style.position,l.style.overflow)),c.onload=function(){function o(o){f.init(),f.move(o),a.stop().fadeTo(e.support.opacity?n.duration:0,1,!!e.isFunction(n.onZoomIn)&&n.onZoomIn.call(c))}function t(){a.stop().fadeTo(n.duration,0,!!e.isFunction(n.onZoomOut)&&n.onZoomOut.call(c))}var f=e.zoom(l,s,c,n.magnify);"grab"===n.on?i.on("mousedown.zoom",function(n){1===n.which&&(e(document).one("mouseup.zoom",function(){t(),e(document).off(r,f.move)}),o(n),e(document).on(r,f.move),n.preventDefault())}):"click"===n.on?i.on("click.zoom",function(n){return d?void 0:(d=!0,o(n),e(document).on(r,f.move),e(document).one("click.zoom",function(){t(),d=!1,e(document).off(r,f.move)}),!1)}):"toggle"===n.on?i.on("click.zoom",function(e){d?t():o(e),d=!d}):"mouseover"===n.on&&(f.init(),i.on("mouseenter.zoom",o).on("mouseleave.zoom",t).on(r,f.move)),n.touch&&i.on("touchstart.zoom",function(e){e.preventDefault(),u?(u=!1,t()):(u=!0,o(e.originalEvent.touches[0]||e.originalEvent.changedTouches[0]))}).on("touchmove.zoom",function(e){e.preventDefault(),f.move(e.originalEvent.touches[0]||e.originalEvent.changedTouches[0])}).on("touchend.zoom",function(e){e.preventDefault(),u&&(u=!1,t())}),e.isFunction(n.callback)&&n.callback.call(c)},c.setAttribute("role","presentation"),c.alt="",c.src=n.url})},e.fn.zoom.defaults=o}(window.jQuery),function(e){e.fn.niceSelect=function(o){function t(o){o.after(e("<div></div>").addClass("nice-select").addClass(o.attr("class")||"").addClass(o.attr("disabled")?"disabled":"").attr("tabindex",o.attr("disabled")?null:"0").html('<span class="current"></span><ul class="list"></ul>'));var t=o.next(),n=o.find("option"),l=o.find("option:selected");t.find(".current").html(l.data("display")||l.text()),n.each(function(o){var n=e(this),l=n.data("display");t.find("ul").append(e("<li></li>").attr("data-value",n.val()).attr("data-display",l||null).addClass("option"+(n.is(":selected")?" selected":"")+(n.is(":disabled")?" disabled":"")).html(n.text()))})}if("string"==typeof o)return"update"==o?this.each(function(){var o=e(this),n=e(this).next(".nice-select"),l=n.hasClass("open");n.length&&(n.remove(),t(o),l&&o.next().trigger("click"))}):"destroy"==o?(this.each(function(){var o=e(this),t=e(this).next(".nice-select");t.length&&(t.remove(),o.css("display",""))}),0==e(".nice-select").length&&e(document).off(".nice_select")):console.log('Method "'+o+'" does not exist.'),this;this.hide(),this.each(function(){var o=e(this);o.next().hasClass("nice-select")||t(o)}),e(document).off(".nice_select"),e(document).on("click.nice_select",".nice-select",function(o){var t=e(this);e(".nice-select").not(t).removeClass("open"),t.toggleClass("open"),t.hasClass("open")?(t.find(".option"),t.find(".focus").removeClass("focus"),t.find(".selected").addClass("focus")):t.focus()}),e(document).on("click.nice_select",function(o){0===e(o.target).closest(".nice-select").length&&e(".nice-select").removeClass("open").find(".option")}),e(document).on("click.nice_select",".nice-select .option:not(.disabled)",function(o){var t=e(this),n=t.closest(".nice-select");n.find(".selected").removeClass("selected"),t.addClass("selected");var l=t.data("display")||t.text();n.find(".current").text(l),n.prev("select").val(t.data("value")).trigger("change")}),e(document).on("keydown.nice_select",".nice-select",function(o){var t=e(this),n=e(t.find(".focus")||t.find(".list .option.selected"));if(32==o.keyCode||13==o.keyCode)return t.hasClass("open")?n.trigger("click"):t.trigger("click"),!1;if(40==o.keyCode){if(t.hasClass("open")){var l=n.nextAll(".option:not(.disabled)").first();l.length>0&&(t.find(".focus").removeClass("focus"),l.addClass("focus"))}else t.trigger("click");return!1}if(38==o.keyCode){if(t.hasClass("open")){var s=n.prevAll(".option:not(.disabled)").first();s.length>0&&(t.find(".focus").removeClass("focus"),s.addClass("focus"))}else t.trigger("click");return!1}if(27==o.keyCode)t.hasClass("open")&&t.trigger("click");else if(9==o.keyCode&&t.hasClass("open"))return!1});var n=document.createElement("a").style;return n.cssText="pointer-events:auto","auto"!==n.pointerEvents&&e("html").addClass("no-csspointerevents"),this}}(jQuery);
