	...
	var G = {
						...
						for(var M, z = t.slidesPerColumn, P = T / z, k = Math.floor(h / t.slidesPerColumn), $ = 0; $ < h; $ += 1) {
							...
							if("none" !== L.css("display")) {
								if("auto" === t.slidesPerView) {
									...
									if(H && (L[0].style.transform = "none"), X && (L[0].style.webkitTransform = "none"), t.roundLengths) S = this.isHorizontal() ? L.outerWidth(!0) : L.outerHeight(!0);
									...
									H && (L[0].style.transform = H), X && (L[0].style.webkitTransform = X), t.roundLengths && (S = Math.floor(S))
								} else S = (s - (t.slidesPerView - 1) * y) / t.slidesPerView, t.roundLengths && (S = Math.floor(S)), d[$] && (this.isHorizontal() ? d[$].style.width = S + "px" : d[$].style.height = S + "px");
								d[$] && (d[$].swiperSlideSize = S), c.push(S), t.centeredSlides ? (b = b + S / 2 + E / 2 + y, 0 === E && 0 !== $ && (b = b - s / 2 - y), 0 === $ && (b = b - s / 2 - y), Math.abs(b) < .001 && (b = 0), t.roundLengths && (b = Math.floor(b)), x % t.slidesPerGroup == 0 && p.push(b), u.push(b)) : (t.roundLengths && (b = Math.floor(b)), (x - Math.min(this.params.slidesPerGroupSkip, x)) % this.params.slidesPerGroup == 0 && p.push(b), u.push(b), b = b + S + y), this.virtualSize += S + y, E = S, x += 1
							}
						}
				...
				slideTo: function(e, t, i, s) {
					...
					if(l.cssMode) {
						var y, b = r.isHorizontal(),
							E = -g;
						return u && (E = c.scrollWidth - c.offsetWidth - E), 0 === t ? c[b ? "scrollLeft" : "scrollTop"] = E : c.scrollTo ? c.scrollTo(((y = {})[b ? "left" : "top"] = E, y.behavior = "smooth", y)) : c[b ? "scrollLeft" : "scrollTop"] = E, !0
					}
			...
			events: {
				attachEvents: function() {
					...
					this.onTouchStart = I.bind(this), this.onTouchMove = function(e) {
						...
						if(t.allowClick && (t.updateClickedSlide(d), t.emit("tap click", d), u < 300 && p - i.lastClickTime < 300 && t.emit("doubleTap doubleClick", d)), i.lastClickTime = E(), b(function() {
					...
					if(!l.touch && l.pointerEvents) s.addEventListener(i.start, this.onTouchStart, !1), e.addEventListener(i.move, this.onTouchMove, o), e.addEventListener(i.end, this.onTouchEnd, !1);
						...
						if(l.touch) {
							...
							s.addEventListener(i.start, this.onTouchStart, d), s.addEventListener(i.move, this.onTouchMove, l.passiveListener ? {
								passive: !1,
								capture: o
							} : o), s.addEventListener(i.end, this.onTouchEnd, d), i.cancel && s.addEventListener(i.cancel, this.onTouchEnd, d), A || (e.addEventListener("touchstart", D), A = !0)
				...
				setBreakpoint: function() {
					...
					if(n && (!n || 0 !== Object.keys(n).length)) {
						...
						if(l && this.currentBreakpoint !== l) {
							...
							u && t && this.changeDirection(), C(this.params, d), C(this, {
		...
		H = function() {
			function t() {
				...
				var l = C({}, G);
				n.useParams(l), n.params = C({}, l, B, i), n.originalParams = C({}, n.params), n.passedParams = C({}, i), n.params && n.params.on && Object.keys(n.params.on).forEach(function(e) {
				...
				if(e = o[0]) {
					...
					return e.swiper = n, e && e.shadowRoot && e.shadowRoot.querySelector ? (h = f(e.shadowRoot.querySelector("." + n.params.wrapperClass))).children = function(e) {
						return o.children(e)
					} : h = o.children("." + n.params.wrapperClass), C(n, {
						$el: o,
						el: e,
						$wrapperEl: h,
						wrapperEl: h[0],
	...
	var X = {
		...
		R = {
			...
			handle: function(e) {
				...
				if(s.invert && (r = -r), i.params.freeMode) {
					...
					if(!h) {
						...
						if(p >= i.minTranslate() && (p = i.minTranslate()), p <= i.maxTranslate() && (p = i.maxTranslate()), i.setTransition(0), i.setTranslate(p), i.updateProgress(), i.updateActiveIndex(), i.updateSlidesClasses(), (!u && i.isBeginning || !c && i.isEnd) && i.updateSlidesClasses(), i.params.freeModeSticky) {
							...
							if(v.push(o), m && (o.delta > m.delta || o.direction !== m.direction)) v.splice(0);
								...
								var w = r > 0 ? .8 : .2;
								i.mousewheel.lastEventBeforeSnap = o, v.splice(0), i.mousewheel.timeout = b(function() {
					...
					if(x.push(y), T ? (y.direction !== T.direction || y.delta > T.delta || y.time > T.time + 150) && i.mousewheel.animateSlider(y) : i.mousewheel.animateSlider(y), i.mousewheel.releaseScroll(y)) return !0
				}
		...
		J = {
			...
			init: function() {
				...
				e.a11y.addElId(n, l), s = e.params.autoplay && e.params.autoplay.enabled ? "off" : "polite", e.a11y.addElLive(n, s), t.itemRoleDescriptionMessage && e.a11y.addElRoleDescription(f(e.slides), t.itemRoleDescriptionMessage), e.a11y.addElRole(f(e.slides), "group"), e.slides.each(function(t) {
					var i = f(t);
			...
			setTranslate: function() {
				...
				for(var c = 0; c < s.length; c += 1) {
					...
					var y = Math.max(Math.min(v[0].progress, 1), -1),
						...
						E = 0,
						x = 0;
					m % 4 == 0 ? (b = 4 * -w * l, x = 0) : (m - 1) % 4 == 0 ? (b = 0, x = 4 * -w * l) : (m - 2) % 4 == 0 ? (b = l + 4 * w * l, x = l) : (m - 3) % 4 == 0 && (b = -l, x = 3 * l + 4 * l * w), n && (b = -b), h || (E = b, b = 0);
...
! function(e, o, t) {
	"use strict";
	e.fn.scrollUp = function(o) {
		e.data(t.body, "scrollUp") || (e.data(t.body, "scrollUp", !0), e.fn.scrollUp.init(o))
	}, e.fn.scrollUp.init = function(n) {
		var l, s, i, c, a, r, d = e.fn.scrollUp.Settings = e.extend({}, e.fn.scrollUp.defaults, n),
			u = !1;
		switch(r = d.scrollTrigger ? e(d.scrollTrigger) : e("<a/>", {
			id: d.scrollName,
			href: "#top"
		}), d.scrollTitle && r.attr("title", d.scrollTitle), r.appendTo("body"), d.scrollImg || d.scrollTrigger || r.html(d.scrollText), r.css({
			display: "none",
			position: "fixed",
			zIndex: d.zIndex
			...
			case "fade":
				l = "fadeIn", s = "fadeOut", i = d.animationSpeed;
				break;
			case "slide":
				l = "slideDown", s = "slideUp", i = d.animationSpeed;
				break;
			default:
				l = "show", s = "hide", i = 0
		}
		c = "top" === d.scrollFrom ? d.scrollDistance : e(t).height() - e(o).height() - d.scrollDistance, e(o).scroll(function() {
			e(o).scrollTop() > c ? u || (r[l](i), u = !0) : u && (r[s](i), u = !1)
		}), d.scrollTarget ? "number" == typeof d.scrollTarget ? a = d.scrollTarget : "string" == typeof d.scrollTarget && (a = Math.floor(e(d.scrollTarget).offset().top)) : a = 0, r.click(function(o) {
		...
		e.removeData(t.body, "scrollUp"), e("#" + e.fn.scrollUp.Settings.scrollName).remove(), e("#" + e.fn.scrollUp.Settings.scrollName + "-active").remove(), e.fn.jquery.split(".")[1] >= 7 ? e(o).off("scroll", n) : e(o).unbind("scroll", n)
...
function(e) {
	...
	e.zoom = function(o, t, n, l) {
		var s, i, c, a, r, d, u, f = e(o),
			p = f.css("position"),
			m = e(t);
		return o.style.position = /(absolute|fixed)/.test(p) ? p : "relative", o.style.overflow = "hidden", n.style.width = n.style.height = "", e(n).addClass("zoomImg").css({
			position: "absolute",
			top: 0,
			left: 0,
			opacity: 0,
			...
			init: function() {
				i = f.outerWidth(), s = f.outerHeight(), t === o ? (a = i, c = s) : (a = m.outerWidth(), c = m.outerHeight()), r = (n.width - i) / a, d = (n.height - s) / c, u = m.offset()
			},
			move: function(e) {
				var o = e.pageX - u.left,
					t = e.pageY - u.top;
				t = Math.max(Math.min(t, c), 0), o = Math.max(Math.min(o, a), 0), n.style.left = o * -r + "px", n.style.top = t * -d + "px"
			}
		}
	}, e.fn.zoom = function(t) {
		return this.each(function() {
			var n = e.extend({}, o, t || {}),
				l = n.target && e(n.target)[0] || this,
				s = this,
				i = e(s),
			...
			if(!n.url) {
				...
				if(f && (n.url = f.getAttribute("data-src") || f.currentSrc || f.src), !n.url) return
			}
			i.one("zoom.destroy", function(e, o) {
				i.off(".zoom"), l.style.position = e, l.style.overflow = o, c.onload = null, a.remove()
			}.bind(this, l.style.position, l.style.overflow)), c.onload = function() {
				function o(o) {
					f.init(), f.move(o), a.stop().fadeTo(e.support.opacity ? n.duration : 0, 1, !!e.isFunction(n.onZoomIn) && n.onZoomIn.call(c))
				}

				function t() {
					a.stop().fadeTo(n.duration, 0, !!e.isFunction(n.onZoomOut) && n.onZoomOut.call(c))
				}
				var f = e.zoom(l, s, c, n.magnify);
				"grab" === n.on ? i.on("mousedown.zoom", function(n) {
					1 === n.which && (e(document).one("mouseup.zoom", function() {
						t(), e(document).off(r, f.move)
					}), o(n), e(document).on(r, f.move), n.preventDefault())
				}) : "click" === n.on ? i.on("click.zoom", function(n) {
					return d ? void 0 : (d = !0, o(n), e(document).on(r, f.move), e(document).one("click.zoom", function() {
						t(), d = !1, e(document).off(r, f.move)
					}), !1)
				}) : "toggle" === n.on ? i.on("click.zoom", function(e) {
					d ? t() : o(e), d = !d
				}) : "mouseover" === n.on && (f.init(), i.on("mouseenter.zoom", o).on("mouseleave.zoom", t).on(r, f.move)), n.touch && i.on("touchstart.zoom", function(e) {
					e.preventDefault(), u ? (u = !1, t()) : (u = !0, o(e.originalEvent.touches[0] || e.originalEvent.changedTouches[0]))
				}).on("touchmove.zoom", function(e) {
					e.preventDefault(), f.move(e.originalEvent.touches[0] || e.originalEvent.changedTouches[0])
				}).on("touchend.zoom", function(e) {
					e.preventDefault(), u && (u = !1, t())
				}), e.isFunction(n.callback) && n.callback.call(c)
			}, c.setAttribute("role", "presentation"), c.alt = "", c.src = n.url
		})
	}, e.fn.zoom.defaults = o
}(window.jQuery),
function(e) {
	e.fn.niceSelect = function(o) {
		function t(o) {
			o.after(e("<div></div>").addClass("nice-select").addClass(o.attr("class") || "").addClass(o.attr("disabled") ? "disabled" : "").attr("tabindex", o.attr("disabled") ? null : "0").html('<span class="current"></span><ul class="list"></ul>'));
			var t = o.next(),
				n = o.find("option"),
				l = o.find("option:selected");
			t.find(".current").html(l.data("display") || l.text()), n.each(function(o) {
				var n = e(this),
					l = n.data("display");
				t.find("ul").append(e("<li></li>").attr("data-value", n.val()).attr("data-display", l || null).addClass("option" + (n.is(":selected") ? " selected" : "") + (n.is(":disabled") ? " disabled" : "")).html(n.text()))
			})
		}
		if("string" == typeof o) return "update" == o ? this.each(function() {
			var o = e(this),
				n = e(this).next(".nice-select"),
				l = n.hasClass("open");
			n.length && (n.remove(), t(o), l && o.next().trigger("click"))
		}) : "destroy" == o ? (this.each(function() {
			var o = e(this),
				t = e(this).next(".nice-select");
			t.length && (t.remove(), o.css("display", ""))
		}), 0 == e(".nice-select").length && e(document).off(".nice_select")) : console.log('Method "' + o + '" does not exist.'), this;
		this.hide(), this.each(function() {
			var o = e(this);
			o.next().hasClass("nice-select") || t(o)
		}), e(document).off(".nice_select"), e(document).on("click.nice_select", ".nice-select", function(o) {
			var t = e(this);
			e(".nice-select").not(t).removeClass("open"), t.toggleClass("open"), t.hasClass("open") ? (t.find(".option"), t.find(".focus").removeClass("focus"), t.find(".selected").addClass("focus")) : t.focus()
		}), e(document).on("click.nice_select", function(o) {
			0 === e(o.target).closest(".nice-select").length && e(".nice-select").removeClass("open").find(".option")
		}), e(document).on("click.nice_select", ".nice-select .option:not(.disabled)", function(o) {
			var t = e(this),
				n = t.closest(".nice-select");
			n.find(".selected").removeClass("selected"), t.addClass("selected");
			var l = t.data("display") || t.text();
			n.find(".current").text(l), n.prev("select").val(t.data("value")).trigger("change")
		}), e(document).on("keydown.nice_select", ".nice-select", function(o) {
			var t = e(this),
				n = e(t.find(".focus") || t.find(".list .option.selected"));
			if(32 == o.keyCode || 13 == o.keyCode) return t.hasClass("open") ? n.trigger("click") : t.trigger("click"), !1;
			if(40 == o.keyCode) {
				if(t.hasClass("open")) {
					var l = n.nextAll(".option:not(.disabled)").first();
					l.length > 0 && (t.find(".focus").removeClass("focus"), l.addClass("focus"))
			...
			if(27 == o.keyCode) t.hasClass("open") && t.trigger("click");
			else if(9 == o.keyCode && t.hasClass("open")) return !1
		});
...
! function(t) {
			...
			t.position = {
				...
				return m = function(e) {
					...
					var a, r, l = t(this),
						...
						m = i(this, "marginLeft"),
						k = i(this, "marginTop"),
						x = h + m + i(this, "marginRight") + b.width,
						C = u + k + i(this, "marginBottom") + b.height,
						D = t.extend({}, g),
						I = e(w.my, l.outerWidth(), l.outerHeight());
					"right" === s.my[0] ? D.left -= h : "center" === s.my[0] && (D.left -= h / 2), "bottom" === s.my[1] ? D.top -= u : "center" === s.my[1] && (D.top -= u / 2), D.left += I[0], D.top += I[1], a = {
						marginLeft: m,
						marginTop: k
	...
	t.effects.define("blind", "hide", function(e, i) {
		...
		for(t.effects.createPlaceholder(a), o = a.css(m), u || (u = a["top" === m ? "outerHeight" : "outerWidth"]() / 3), h && ((n = {
				opacity: 1
			})[m] = o, a.css("opacity", 0).css(m, _ ? 2 * -u : 2 * u).animate(n, f, g)), l && (u /= Math.pow(2, d - 1)), (n = {})[m] = o; d > v; v++)(s = {})[m] = (_ ? "-=" : "+=") + u, a.animate(s, f, g).animate(n, f, g), u = l ? 2 * u : u / 2;
		l && ((s = {
			opacity: 0
...
! function(r) {
	...
	r.fn.LineProgressbar = function(t) {
		return t = r.extend({
			...
			height: "7px",
			width: "100%"
		}, t), r.options = t, this.each(function(a, o) {
			...
			n.css({
				...
				borderRadius: t.radius
			}), t.animation ? n.animate({
				width: t.percentage + "%"
			}, {
				step: function(a) {
					t.ShowProgressCount && r(o).find(".percentCount").text(Math.round(a) + t.unit)
				},
				duration: t.duration
			}) : (n.css("width", t.percentage + "%"), r(o).find(".percentCount").text(Math.round(t.percentage) + "%"))
		})
	}
