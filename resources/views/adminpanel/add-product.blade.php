    ...
    <div class="container">
        <div class="login_form_container">
            <div class="account_login_form">
                <form action="{{ url('/') }}/admin/add-new-product" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="default-form-box mb-20">
                                ...
                                <input type="number" min="0" max="50" name="product_price_off">
                                <span class="text-danger">
                                    @error('product_price_off')
                                        {{ $message }}
                                    @enderror
                                </span>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="default-form-box mb-20">
                                ...
                                <textarea type="text" row="3" name="product_description"></textarea>
                            </div>
                            <span class="text-danger">
                        ...
                        <div class="col-md-12">
                            <div class="panel">
                                <div class="button_outer">
                                    <div class="btn_upload">
                                        <input type="file" id="add_product_image_upload" name="product_image"> Upload Product Image
                                    </div>
                            ...
                            <div class="uploaded_file_view" id="uploaded_view" style="border: px solid black;">
                                <span class="file_remove">X</span>
                            </div>
                        </div>
                    </div>
                    <div class="save_button mt-3">
                        <button class="btn btn-color-dark btn-hover-color-primary" type="submit">Add New Product</button>
                    </div>
                </form>
            </div>
        </div>
